...
public class ShowMap extends BaseActivity implements TencentLocationListener,HttpListener {
    ...
    public void onHttpFinish(int state, String responseData) {
        if (state == -1){
            Toast.makeText(ShowMap.this,getResources().getString(R.string.network_exception),Toast.LENGTH_SHORT).show();
        }else {
            ...
            if ((mDoctorList !=null) && (mDoctorList.size() >0)) {
                ...
                adapter = new DoctorAdapter(mDoctorList,ShowMap.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        warningDialog = new AlertDialog.Builder(ShowMap.this);
        ...
        finishDialog = new AlertDialog.Builder(ShowMap.this);
    ...
    private void cancelSOS(){
        HttpConnector.sendLocation(-1,mynum,mynum,sos, 0, 0, ShowMap.this);
        ...
        Intent intent = new Intent(ShowMap.this, CallingService.class);
        stopService(intent);
    ...
    private void setMessage(){
        final EditText inputServer = new EditText(ShowMap.this);
 ...
 */
    ...
    private void reportMyStateChanged(final int myState){
        HttpConnector.reportMyStateChanged(mynum, myState, new HttpListener() {
            @Override
            public void onHttpFinish(int state, String responseData) {
                if (state == -1){
                    Toast.makeText(ShowMap.this,getResources().getString(R.string.network_exception),Toast.LENGTH_SHORT).show();
    ...
    public void parseJSON(String jsonData){
        try {
            ...
            Log.e("showMap--parse","-------------------"+jsonArray.length());
    ...
    public void onLocationChanged(TencentLocation location, int error, String reason) {
        if (TencentLocation.ERROR_OK == error) {
            ...
            HttpConnector.sendLocation(0,mynum,mynum,sos, location.getLatitude(), location.getLongitude(),ShowMap.this);
        } else {
            // 定位失败
        }
    }
